...
function sendAPNS(deviceToken, message, app) {
    ...
    var apnProvider = new apn.Provider({
                                       ...
                                       keyId: 'SNYAQCEXW6', // The Key ID of the p8 file (available at https://developer.apple.com/account/ios/certificate/key)
                                       teamId: 'WD65G8C4YP' // The Team ID of your Apple Developer Account (available at https://developer.apple.com/account/#/membership/)
                                       },
